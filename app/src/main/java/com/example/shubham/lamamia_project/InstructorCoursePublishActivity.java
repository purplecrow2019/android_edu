...
public class InstructorCoursePublishActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instructor_course_publish);

        // Course id holder casting
...
//            courseName.setText(course_name);
        ...
        // Publish
        Button coursePublish = findViewById(R.id.publish);
        coursePublish.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                publishCourse(courseIdHolder.getText().toString().trim());
            }
        });
    ...
    // Publish course method
    private void publishCourse(String course_id){
        ...
        if (sharedPreferences.contains("user_id")
            ...
            String url = Constants.COURSE_PUBLISH_REQUEST_INSTRUCTOR + course_id;
