...
public class InstructorQuestionDeleteActivity extends AppCompatActivity {

    private EditText questionIdHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instructor_question_delete);
        ...
        try{
            String video_name = Objects.requireNonNull(getIntent().getExtras()).getString("question_text");
            videoName.setText(video_name);
            String video_id = Objects.requireNonNull(getIntent().getExtras()).getString("question_id");
            questionIdHolder.setText(video_id);
        }catch (Exception e) {
            e.printStackTrace();
        }
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                deleteQuestion(questionIdHolder.getText().toString().trim());
            }
        });
    ...
    private void deleteQuestion(String question_id){
        ...
        if (sharedPreferences.contains("user_id")
            ...
            String url = Constants.DELETE_QUESTION_INSTRUCTOR + question_id;
