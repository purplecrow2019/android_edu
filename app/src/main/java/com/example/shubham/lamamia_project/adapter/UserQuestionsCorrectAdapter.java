...
public class UserQuestionsCorrectAdapter extends RecyclerView.Adapter<UserQuestionsCorrectAdapter.ViewHolder>{

    private ArrayList<UserQuestionCorrectList> listItems;
    ...
    public UserQuestionsCorrectAdapter(ArrayList<UserQuestionCorrectList> question_List, Context context, Activity activity, AdapterCallback callback) {
    ...
    @NonNull
    @Override
    public UserQuestionsCorrectAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_user_questions_all, parent, false);
        return new UserQuestionsCorrectAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final UserQuestionsCorrectAdapter.ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        final UserQuestionCorrectList listItem = listItems.get(position);
