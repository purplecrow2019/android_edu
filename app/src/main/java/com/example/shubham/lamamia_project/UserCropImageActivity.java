...
public class UserCropImageActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_crop_image);
    ...
    public void onGetCroppedImageComplete(CropImageView view, Bitmap bitmap, Exception error) {
        if (error == null) {
            ...
            try {
                ...
                if (myPath != null) {
                    UserCropImageActivity.UploadAsyncTask uploadAsyncTask = new UserCropImageActivity.UploadAsyncTask(UserCropImageActivity.this);
    ...
    private class UploadAsyncTask extends AsyncTask<Void, Integer, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            if (sharedPreferences.contains("user_id")
                ...
                final String SERVER_PATH = Constants.UPLOAD_PROFILE_IMAGE_USER + sharedPreferences.getString("user_id", DEFAULT);
