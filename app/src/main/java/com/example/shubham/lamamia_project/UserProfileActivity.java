...
public class UserProfileActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    private LinearLayout emailHolder, phoneHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent activityChangeIntent = new Intent(UserProfileActivity.this, UserProfileUpdate.class);
                activityChangeIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                activityChangeIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                UserProfileActivity.this.startActivity(activityChangeIntent);
            }
        });
        ...
        setImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (EasyPermissions.hasPermissions(UserProfileActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                    showFileChooserIntent();
                } else {
                    //If permission is not present request for the same.
                    EasyPermissions.requestPermissions(UserProfileActivity.this, getString(R.string.read_file), READ_REQUEST_CODE, Manifest.permission.READ_EXTERNAL_STORAGE);
                }
            }
        });
    ...
    private void previewFile(Uri uri) {
        ...
        Intent activityChangeIntent = new Intent(UserProfileActivity.this, UserCropImageActivity.class);
